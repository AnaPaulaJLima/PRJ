            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Edição Usuário</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">                 
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="updateUser.php" method="POST" role="form" enctype="multipart/form-data"">
                                    <div class="form-group">
                                        <label class="col-md-12">Nome Completo</label>
                                        <div class="col-md-12">
                                            <input type="text" name="nome" class="form-control form-control-line" value="<?php echo $user ['nome']?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="email" class="form-control form-control-line" name="email" value="<?php echo $user ['email']?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="celular" value="<?php echo $user ['celular']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <a href="listUsers.php" class="btn btn-link">Cancelar</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
